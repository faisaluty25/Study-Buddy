...
study_helper = {
    r"how to prepare for the exam|\bprepare for exam\b": [
    ...
    r"\b(how to focus|stay focused|avoid distractions|focus)\b": [
    ...
    r"\b(how to manage time|time management tips)\b": [
        "Create a daily schedule and stick to it.",
        "Prioritize tasks using the Eisenhower Matrix (urgent vs. important).",
        "Break big tasks into smaller, manageable chunks."
    ],

    r"\b(feeling unmotivated|study motivation)\b": [
...
general_problems = {
    ...
    r"\b(cannot focus|hard to concentrate|easily distracted)\b": [
